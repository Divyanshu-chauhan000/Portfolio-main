      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          <div className="text-center md:text-left">
            <span className="inline-block mb-4 px-4 py-1 text-xs sm:text-sm font-medium rounded-full bg-gray-100 text-gray-700">
              About Me
            </span>
            ...
            <p className="text-gray-500 mb-4 sm:mb-5 leading-relaxed text-sm sm:text-base">
              I am a MERN Stack Developer with experience in building full-stack
              web applications and cross-platform mobile apps using React
              Native.
            </p>
            <p className="text-gray-500 mb-4 sm:mb-5 leading-relaxed text-sm sm:text-base">
              I focus on writing clean, maintainable code and building scalable
              backend systems with efficient APIs. Along with web and mobile
              development, I have experience integrating AI-based features into
              applications, making them smarter and more interactive.
            </p>
            <p className="text-gray-500 mb-4 sm:mb-5 leading-relaxed text-sm sm:text-base">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
             {/* <NavLink to="/resume">
              ...
              <NavLink to="/projects">
                ...
                className="px-5 sm:px-7 py-2.5 sm:py-3 rounded-xl border text-gray-800 bg-gray-200 font-medium hover:bg-black hover:text-gray-200 transition text-sm sm:text-base text-center"
              >
                View Projects
              </button>
              </NavLink>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-5 mt-8 md:mt-0">
            {[
              ...
              <div
                key={index}
                className="group p-3 sm:p-5 rounded-2xl bg-white border shadow-sm hover:shadow-lg transition"
              >
                <div className="text-gray-900 font-semibold mb-1 group hover:text-purple-600 transition text-sm sm:text-base">
                  {skill}
                </div>
